...
bot = TeleBot(token='6841216339:AAHobS6_aAw2NRzyhjcVBb2d6tNSBXk-e5U', parse_mode='html') # создание бота
...
def start_command_handler(message: Привет, сделаем тебе карточку):
...
@bot.message_handler()
def message_handler(message: Супер):
